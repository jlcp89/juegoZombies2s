package net.d3sarrollo.zombie_defense_random_maps.ui.view;
...
import net.d3sarrollo.zombie_defense_random_maps.R;
import net.d3sarrollo.zombie_defense_random_maps.model.object.Bala;
import net.d3sarrollo.zombie_defense_random_maps.model.object.Bloque;
import net.d3sarrollo.zombie_defense_random_maps.model.object.Jugador;
import net.d3sarrollo.zombie_defense_random_maps.model.object.Nivel;
import net.d3sarrollo.zombie_defense_random_maps.model.object.Zombie;
...
public class GameView extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener {
    ...
    public int[] regresarCoordenadasJugador1(){
        int[] coord = new int[2];
